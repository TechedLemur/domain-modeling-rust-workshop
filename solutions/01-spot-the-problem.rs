...
fn main() {
    ...
    let impossible_order_2 = Order {
        ...
        is_paid: true,
        is_shipped: true,
        // Missing both `payment_id` and `tracking_number`
        payment_id: None,
    ...
    let impossible_order_3 = Order {
        id: "789".to_string(),
        is_paid: false,   // Not paid, but has payment id.
        is_shipped: true, // Shipped without payment
        payment_id: Some("payment-123".to_string()),
        tracking_number: None,
    };
